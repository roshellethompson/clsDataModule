...
Public Class clsInterface
    ...
    Public Function SelectPendingReviews() As DataSet
        Dim ds As DataSet = New clsData().SelectPendingReviews()
        Return ds
    End Function
    ...
    End Function
    Public Function GetCustomerDataFromLogin(ByVal Login As String) As XmlElement
        Dim oData As New clsData
        Return oData.GetCustomerDataFromLogin(Login)
    End Function
...
ByVal SSN As String, ByVal Sex As String, ByVal TransactionType As String, ByVal BK_Flag As Integer, ByVal PAN As String) As Integer
 ...
 SSN, Sex, TransactionType, BK_Flag, PAN)
    ...
    Public Function GetAllTransactionsByAcct(ByVal iActID As Integer) As List(Of clsTranRow)
        Return New clsData().GetAllTransactionsbyAccount(iActID)
    End Function
    ...
    Public Function COMMS(ByVal iCustID As Integer, ByVal strSeg As clsLabel()) As XmlElement
        ...
        Try
            ...
            Dim xmlParts As XmlElement = oData.GetCustomerDataFromID("", Date.Now, "", iCustID, "", "", 0, 0, 0)
            If xmlParts.ChildNodes.Count = 0 Then
                ReturnCode2.InnerText = "X"
                root.AppendChild(ReturnCode1)
                root.AppendChild(ReturnCode2)
            ...
            For Each xmlPart As XmlNode In xmlParts
                ...
                ElseIf xmlPart.Name = "iLangID" Then
                    If IsDBNull(xmlPart.InnerText) Or xmlPart.InnerText = "" Then
                        iLangID = 1
                    Else
                        iLangID = Int32.Parse(xmlPart.InnerText)
                    End If
                End If
            Next
    ...
    Public Function RetrieveCompanyNumberForPan(ByVal Bin As String, ByVal PanLastFour As String) As Integer
        Return New clsData().IFX_RetrieveCompanyNumberForPan(Bin, PanLastFour)
    End Function

    Public Function RetrieveBarcodeForPan(ByVal Bin As String, ByVal PanLastFour As String) As Integer
        Return New clsData().IFX_RetrieveBarcodeForPan(Bin, PanLastFour)
    End Function
