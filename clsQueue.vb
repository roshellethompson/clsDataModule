...
Public Class clsQueue
    ...
    Public Function PostToQueue() As Boolean
        Return oChkService.PostAndCheckEZCashQ(iQueueId, ProviderID, WorkstationID, CustomerID, QueueCode, StatusCode, Data1, Data2, Data3, Data4, Data5, ReturnCode1, ReturnCode2, ReturnCode3, ReturnCode4, 20)
    End Function
